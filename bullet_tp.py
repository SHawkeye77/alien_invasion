...
class Bullet(Sprite): #format is... 'class ChildClass(ParentClass):'
    ...
    def __init__(self,ai_settings,screen,ship):
        ...
        self.rect.centery = ship.rect.centery #Positioning the bullet's center x coordinate at the same place as the ships
        self.rect.right = ship.rect.right #Positioning the top of the bullet at the same place as the top of the ship
    ...
    def update(self):
        ...
        self.x += self.speed_factor #Updates position of the bullet higher on the screen
